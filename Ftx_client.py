...
class Ftx_client:
    ...
    def get_conditional_order_history(self, market: str = None, side: str = None, 
                                        type: str = None, order_type: str = None, 
    ...
    def set_account_leverage(self, value: float) -> None:
        self._post('account/leverage', {'leverage': value})
